...
package object barneshut
{
  ...
  case class Fork(nw: Quad, ne: Quad, sw: Quad, se: Quad) extends Quad
  {
    ...
    val size: Float = (centerX + centerY) * 2
      ...
      extends Quad
  {
    ...
    val massX = bodies.foldLeft(0f)((b,a) => b + a.mass * a.x) / mass
    val massY = bodies.foldLeft(0f)((b,a) => b + a.mass * a.y) / mass
    ...
    def insert(b: Body): Quad =
    {
      ...
      else
      {
        ...
        newBodies.foreach(x => fork.insert(x))
        fork
      }
    }
  }
